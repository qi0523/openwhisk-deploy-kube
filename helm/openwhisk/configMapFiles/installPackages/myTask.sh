...
git clone https://gitee.com/willyqi/openwhisk /openwhisk
pushd openwhisk
...
git clone https://gitee.com/willyqi/openwhisk-catalog openwhisk-catalog
...
if [ "$OW_INSTALL_ALARM_PROVIDER" == "yes" ]; then
    ...
    git clone https://gitee.com/willyqi/openwhisk-package-alarms.git
...
if [ "$OW_INSTALL_KAFKA_PROVIDER" == "yes" ]; then
    ...
    git clone https://gitee.com/willyqi/openwhisk-package-kafka.git
